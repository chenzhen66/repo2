    ...
    <div class="row">
        ...
        <div class="col-md-4 border" style="padding: 5%">
            <form action="<c:url value='/FoodTypeServlet'/> " method="post">
                <input type="hidden" name="action" value="updateFoodType">
                <input type="hidden" name="id" value="${list.get(0).getId()}">
                <ul class="list-group list-unstyled">
                    <li class="list-group-item-heading form-group"><h2 class="h2">修改菜品类型</h2></li>
                </ul>
                <div class="form-group">
                    <lable>菜品类型</lable>
                    <input name="tname" class="form-control" value="${list.get(0).getTname()}" type="text">
                </div>
                <div class="form-group">
